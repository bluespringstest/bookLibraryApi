...
import { getTemplate, getEmailContent } from '../utils/notificationTemplates.js';

// Import models
import * as models from '../models/index.js';
const { Notification, User, Book } = models;
  ...
  async sendNotification(notification, user, book = null) {
    ...
    if (user.email) {
      try {
        ...
        const emailContent = getEmailContent(notification, user, book);
